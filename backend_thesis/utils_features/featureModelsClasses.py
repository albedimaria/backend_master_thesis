...
# instrument_embedding_model = esstd.TensorflowPredictEffnetDiscogs(graphFilename=os.path.join(model_path, 'discogs-effnet-bs64-1.pb'), output="PartitionedCall:1")
